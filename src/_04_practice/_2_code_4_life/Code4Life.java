...
public class Code4Life {
	...
	public static void main(String[] args) {
		...
		String hoursCodingString = JOptionPane.showInputDialog("How many hours have you spent coding this week?");
		// 2. If it is less than or equal to 2, tell them to stop watching YouTube and
		// write code instead.
		int hoursCodingInt = Integer.parseInt(hoursCodingString);
		if(hoursCodingInt <= 2) {
		...
		else if(hoursCodingInt >= 3 && hoursCodingInt <= 5) {
